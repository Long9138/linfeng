    ...
    <div id="shouyeCarousel">
        <div class="roy_carousel">
            <ul>
                <li>
                    <a href="">
                        <img src="../assets/imgs/Carousel/20180627171843422201.jpg" alt="">
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="../assets/imgs/Carousel/20180627171809139990.jpg" alt="">
                    </a>
                </li>
                <li>
                    <a href="">
                        <img src="../assets/imgs/Carousel/20180627171910188494.jpg" alt="">
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="roy_carousel_prev">
            <img src="../assets/imgs/Carousel/left2.png" alt="">
        </div>
        <div class="roy_carousel_next">
            <img src="../assets/imgs/Carousel/right2.png" alt="">
        </div>
    </div>
</template>
